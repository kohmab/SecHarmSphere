...
class FigParams:
    ...
    epsDk: List[float]
    subAxPos: List[float]
    EpsD_lim: Tuple[float, float]
    w_res_lim: Tuple[float, float]
...
known_fig_params: Dict[Tuple, FigParams] = \
    {
        (0.02, 0.038342535127453434, 2, 0.1):
            FigParams(x_lim=(0.32, 0.59),
                      y_lim=(0, 4.5),
                      epsDk=[4, 3, 2.5, 2],  # , 1.4]
                      subAxPos=[0.67, 0.45, 0.25, 0.518],
                      EpsD_lim=(1.9, 4.1),
                      w_res_lim = (0.35001,0.446)
                      )
    }
...
if __name__ == '__main__':
    ...
    if fig_params:
        ...
        pos2 = [pos1.x0 + 0.045, pos1.y0 + 0.017, pos1.width*1.057, pos1.height*1.11]
